...
import type { OnDragEndResponder, DroppableProvided } from 'react-beautiful-dnd';
...
const DroppablerDiv: FC<props> = ({ children, dispatchFunc, droppableId = `droppable`, isDropDisabled }) => {
